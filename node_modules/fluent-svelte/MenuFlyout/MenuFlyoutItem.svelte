...
import { MenuFlyoutSurface, arrowNavigation, uid, createEventForwarder } from "../internal";
...
function close(event) {
    if (!cascading && closeFlyout && variant === "standard")
        closeFlyout(event);
}
