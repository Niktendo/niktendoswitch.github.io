        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    input = get_svelte_entry_1.getSvelteEntry() || "src/index.js";
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, rollup_plugin_1.generateBundle(input, (options === null || options === void 0 ? void 0 : options.glob) === true)];
                case 3:
                    result = _a.sent();
                    rollup_plugin_1.writeOutput(result, options, input);
                    return [2 /*return*/];
            }
        });
    });
