<script >/** Sandbox ID to be embedded */
export let src = "new";
...
export let highlights = undefined;
...
<style >.sandbox{--sandbox-width:100%;--sandbox-height:500px;block-size:var(--sandbox-height);border:none;border-radius:4px;inline-size:var(--sandbox-width);overflow:hidden}</style>