...
<Metadata title="Handyempfehlungen" description="description located at /src/routes/index.svelte" />

<PageSection id="hero-section">
	<div class="hero-contents">
		<h1>Handyempfehlungen</h1>
		<p>paragraph located at /src/routes/index.svelte.</p>
		<div class="buttons-spacer">
			<Button variant="accent" href="/docs">Los geht's</Button>
			<Button
